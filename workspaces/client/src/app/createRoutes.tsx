  ...
  return [
    {
      children: [
        ...
        {
          async lazy() {
            const {prefetch, ProgramPage} = await
        ...
        {
          async lazy() {
            const {prefetch, SeriesPage} = await
        ...
        {
          async lazy() {
            const {prefetch, TimetablePage} = await
        ...
        {
          async lazy() {
            const {NotFoundPage, prefetch} = await
